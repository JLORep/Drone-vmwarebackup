...
# Create function for windows Open File Dialog (To manually select a CSV)
...
$inputfile = Get-FileName "C:\Users\46020944\Desktop\Split Servers"
$FullVMList = @(import-csv $inputfile)

# VCentre DNS Name
$VCDNS ="VC.ad.mmu.ac.uk"

# Export Location
$ExportLoc = "\\ascfiler1\vm_repository\CloneTest\AutoExport"

# Create PS-Drive Mapping from VMware Datastore to the above location
